...
def main():
    # Define tu consulta SQL para obtener registros donde apellido1 empieza con 'B'
    query = "SELECT * FROM profesor WHERE apellido1 LIKE 'B%';"  # Cambia 'profesor' por el nombre de tu tabla
    ...
    if connection:
        ...
        if df is not None:
            # Exportar a Excel
            export_to_excel(df, 'datos_profesor_B.xlsx')
