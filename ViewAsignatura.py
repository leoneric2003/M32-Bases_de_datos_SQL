...
def main():
    # Define tu consulta SQL para la tabla profesor
    query = "SELECT * FROM asignatura;"  # Cambia 'profesor' por el nombre de tu tabla
    ...
    if connection:
        ...
        if df is not None:
            # Exportar a Excel
            export_to_excel(df, 'datos_asignatura.xlsx')
